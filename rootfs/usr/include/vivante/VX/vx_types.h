...
#endif
#endif
#ifndef VX_INTERNAL_ENTRY
#if defined(_WIN32)
#define VX_INTERNAL_ENTRY __declspec(dllexport)
#else
#define VX_INTERNAL_ENTRY __attribute__((visibility("default")))
#endif
#endif
#ifndef VX_API_CALL
#if defined(_WIN32)
...
#endif
#endif
#ifndef VX_INTERNAL_CALL
#if defined(_WIN32)
#define VX_INTERNAL_CALL __stdcall
#else
#define VX_INTERNAL_CALL
#endif
#endif
#ifndef VX_CALLBACK
#if defined(_WIN32)
...
enum vx_type_e {
    ...
    VX_TYPE_BOOL8           = 0x011,/*!< \brief A <tt>\ref vx_bool8</tt>. */
