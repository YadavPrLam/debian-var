...
get_filename_component(ASSIMP_ROOT_DIR "/usr" REALPATH)
...
if(MSVC)
  ...
  if(ASSIMP_BUILD_SHARED_LIBS)
    ...
    set_target_properties(assimp::assimp PROPERTIES
      ...
      IMPORTED_LOCATION_RELEASE "${ASSIMP_ROOT_DIR}/lib/aarch64-linux-gnu/${sharedLibraryName}"
    )
    list(APPEND _IMPORT_CHECK_TARGETS assimp::assimp )
    list(APPEND _IMPORT_CHECK_FILES_FOR_assimp::assimp "${ASSIMP_ROOT_DIR}/lib/aarch64-linux-gnu/${sharedLibraryName}" )
  else()
    set(staticLibraryName "libassimp${ASSIMP_LIBRARY_SUFFIX}.a")
    set_target_properties(assimp::assimp PROPERTIES
      IMPORTED_LOCATION_RELEASE "${ASSIMP_ROOT_DIR}/lib/aarch64-linux-gnu/${staticLibraryName}"
    )
    list(APPEND _IMPORT_CHECK_TARGETS assimp::assimp )
    list(APPEND _IMPORT_CHECK_FILES_FOR_assimp::assimp "${ASSIMP_ROOT_DIR}/lib/aarch64-linux-gnu/${staticLibraryName}" )
  endif()
endif()
...
set( ASSIMP_LIBRARY_DIRS "${ASSIMP_ROOT_DIR}/lib/aarch64-linux-gnu")
