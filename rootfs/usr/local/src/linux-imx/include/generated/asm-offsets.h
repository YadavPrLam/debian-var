...
#define TSK_ACTIVE_MM 944 /* offsetof(struct task_struct, active_mm) */
...
#define TSK_STACK_CANARY 1120 /* offsetof(struct task_struct, stack_canary) */
...
#define TRAMP_VALIAS -2199050534912 /* TRAMP_VALIAS */
